(() => {
  ...
  var or = (() => {
    ...
    return (l) => {
      for (var w = l.length, U = new Uint8Array((w - (l[w - 1] == "=") - (l[w - 2] == "=")) * 3 / 4 | 0), p = 0, S = 0; p < w; ) {
        var A = i[l.charCodeAt(p++)], q = i[l.charCodeAt(p++)], V = i[l.charCodeAt(p++)], j2 = i[l.charCodeAt(p++)];
  ...
  var v2 = ue;
  a(v2, "Color"), b(v2, "RED", E(255, 0, 0)), b(v2, "GREEN", E(0, 255, 0)), b(v2, "BLUE", E(0, 0, 255)), b(v2, "YELLOW", E(255, 255, 0)), b(v2, "MAGENTA", E(255, 0, 255)), b(v2, "CYAN", E(0, 255, 255)), b(v2, "WHITE", E(255, 255, 255)), b(v2, "BLACK", E(0, 0, 0));
  function E(...i) {
    if (i.length === 0)
      return new v2(255, 255, 255);
    if (i.length === 1) {
      if (i[0] instanceof v2)
        return i[0].clone();
      if (Array.isArray(i[0]) && i[0].length === 3)
        return v2.fromArray(i[0]);
    }
    return new v2(...i);
  }
  __name(E, "E");
  a(E, "rgb");
  var fr = a((i, t, l) => v2.fromHSL(i, t, l), "hsl2rgb");
  ...
  var be = /* @__PURE__ */ __name(class {
    ...
    gen(...t) {
      ...
      if (t.length === 1) {
        ...
        if (t[0] instanceof v2 && t[1] instanceof v2)
...
`;
  ...
  var no = a((i = {}) => {
    let t = (() => {
      ...
      if (i.background) {
        let m = v2.fromArray(i.background);
...
`)
      ...
      return { bind() {
        ...
        for (let g in m) {
          ...
          typeof y == "number" ? r.uniform1f(x, y) : y instanceof R ? r.uniformMatrix4fv(x, false, new Float32Array(y.m)) : y instanceof v2 ? r.uniform4f(x, y.r, y.g, y.b, y.a) : y instanceof Fe ? r.uniform3f(x, y.x, y.y, y.z) : y instanceof L && r.uniform2f(x, y.x, y.y);
        }
        this.unbind();
      } };
    }
    ...
    function We(e) {
      ...
      let u = e.width || 1, c = r.sub(n).unit().normal().scale(u * 0.5), s = [n.sub(c), n.add(c), r.add(c), r.sub(c)].map((o) => {
        var d, h;
        return { pos: de(o.x, o.y, 0), uv: f(0), color: (d = e.color) != null ? d : v2.WHITE, opacity: (h = e.opacity) != null ? h : 1 };
      });
    ...
    function Qe(e) {
      ...
      if (!(n < 3)) {
        if (re(), I(e.pos), ne(e.scale), Je(e.angle), I(e.offset), e.fill !== false) {
          let c = (r = e.color) != null ? r : v2.WHITE, s = e.pts.map((d) => {
            var h;
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
    ...
    function zn() {
      var e, n;
      if (C.inspect) {
        let r = null, u = v2.fromArray((e = i.inspectColor) != null ? e : [0, 0, 255]);
        if (p.root.every((c) => {
          if (!c.area || c.hidden)
            return;
          r || c.isHovering() && (r = c);
